...
old data into the new memory.  Picking the initial size of the heap is very
important, and when there are multiple heaps (as is the case in a generational
garbage collector), these are black magic tuning parameters.
...
as they are fully evacuated. \Red{terminology evacuated}
...
\begin{itemize}
    ...
    \item support for weak pointers and finalizers,~\XXX{} \Red{We might actually want to talk about this, it is probably one of the more voodoo-y parts of the system} and
